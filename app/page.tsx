  ...
  return (
    <main className="min-h-screen overflow-hidden bg-slate-50 text-slate-900">
      <div className="relative isolate">
        <div className="absolute inset-x-0 top-0 -z-10 h-[34rem] bg-[radial-gradient(circle_at_top_left,_rgba(125,211,252,0.42),_transparent_48%),radial-gradient(circle_at_top_right,_rgba(165,243,252,0.5),_transparent_42%)]" />
          ...
          <section className="grid items-center gap-12 pb-16 pt-20 lg:grid-cols-[1.08fr_0.92fr] lg:gap-16 lg:pt-28">
            <div>
              ...
              <div className="mt-9 flex flex-wrap items-center gap-4">
                <Link
                  href="/signup"
                  className="inline-flex items-center rounded-full bg-accent px-6 py-3 text-sm font-semibold text-white shadow-xl shadow-cyan-200/70 transition hover:bg-accent-dark"
                >
                  Get started
            ...
            <div className="relative mx-auto w-full max-w-md">
              ...
              <div className="relative rounded-[2rem] border border-white/80 bg-white/60 p-5 shadow-2xl shadow-sky-200/60 backdrop-blur-2xl">
                <div className="rounded-[1.5rem] border border-sky-100 bg-gradient-to-br from-white via-sky-50 to-cyan-50 p-6">
      ...
      <section className="mx-auto max-w-6xl px-6 pb-20 sm:px-8 lg:px-10">
        <div className="grid gap-5 md:grid-cols-3">
          {features.map((feature, index) => (
            <article
              key={feature.title}
              className="rounded-3xl border border-white/80 bg-white/65 p-6 shadow-lg shadow-sky-100/80 backdrop-blur-xl"
            >
        ...
        <div className="mt-20 overflow-hidden rounded-[2rem] border border-cyan-100 bg-gradient-to-br from-sky-100 via-white to-cyan-100 px-6 py-12 text-center shadow-xl shadow-sky-100/80 sm:px-12">
          ...
          <Link
            href="/signup"
            className="mt-8 inline-flex rounded-full bg-accent px-6 py-3 text-sm font-semibold text-white shadow-lg shadow-cyan-200/70 transition hover:bg-accent-dark"
          >
            Get started
          </Link>
        </div>
